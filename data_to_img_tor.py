...
filtered_data.to_csv('filtered_tor_data.csv', index=False)
filtered_data = pd.read_csv('filtered_tor_data.csv')
...
image_info_df.to_csv('image_info_tor.csv', index=False)
